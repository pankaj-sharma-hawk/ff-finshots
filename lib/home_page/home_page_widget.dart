                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final searchchild =
                              homePageNewsdataRecordList.map((e) => e).toList();
                                              ...
                                              onTap: () async {
                                                await Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                        NewsMainWidget(
                                                      newsId: searchchildItem
                                                          .newsid,
                                                      headline: searchchildItem
                                                          .headline,
                                                      description:
                                                          searchchildItem
                                                              .description,
                                                      minread: searchchildItem
                                                          .minread,
                                                      datetime: searchchildItem
                                                          .datetime,
                                                      imageurl:
                                                          searchchildItem.image,
                                                      tags:
                                                          searchchildItem.tags,
                                                    ),
                                                  ),
                                                );
                                              },
